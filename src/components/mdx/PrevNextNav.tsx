  ...
  return (
    <nav className="flex items-stretch gap-4 mt-12 pt-8 border-t border-border">
      {prev ? (
        <Link
          href={prev.href}
          className="flex-1 group rounded-xl border border-border bg-surface-card p-5 hover:border-teal/30 transition-colors"
        >
      ...
      {next ? (
        <Link
          href={next.href}
          className="flex-1 group rounded-xl border border-border bg-surface-card p-5 hover:border-teal/30 transition-colors text-right"
        >
